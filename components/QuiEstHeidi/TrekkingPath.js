...
export default function TrekkingPath() {
    ...
    const ctx = gsap.context(() => {
      ...
      if (logoPaths.length > 0) {
        ...
        tl.fromTo(
          ...
          logoPaths,
          { fill: "#f5f5f5", duration: 2, ease: "power2.inOut" },
          "-=1"
        );
      }
    }, containerRef);
  ...
  return (
    ...
    >
      {/* Decorative Background Logo - Inline SVG for Drawing Animation */}
      {/* Position: Vertical (rotated 90deg), stuck to right edge, very large */}
      <div className="absolute top-1/2 right-[-500px] -translate-y-1/2 rotate-90 z-0 w-[1200px] h-[300px] opacity-100 origin-center">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 397.392 94.875"
          className="w-full h-full"
        >
          <g className="logo-group" transform="translate(-307.497 -409.501)">
            <path
              className="logo-path"
              d="M272.77,64.749c-.343-2.524-1.628-5.418-4.107-5.069s-4.031,3.98-3.688,6.5a4.525,4.525,0,0,0,5.115,3.9C272.569,69.738,273.114,67.272,272.77,64.749Z"
              transform="translate(320.752 375.375)"
              fill="transparent"
              stroke="#f5f5f5"
              strokeWidth="1.5"
            />
            <path
              className="logo-path"
              d="M338.974,68.764c1.348-1.464,2.013-5.334.568-6.637s-4.93.184-6.279,1.648-.488,4.837.958,6.139S337.627,70.227,338.974,68.764Z"
              transform="translate(337.563 375.91)"
              fill="transparent"
              stroke="#f5f5f5"
              strokeWidth="1.5"
            />
