...
export const prestationsQueryByLocale = (locale) => createLocalizedQuery(locale);

export const prestationBySlugQuery = (locale = "fr") => `*[_type == "prestation" && slug.${locale}.current == $slug][0] {
  _id,
  "title": title.${locale},
  "titleFr": title.fr,
  "titleEn": title.en,
  ...
  "notIncludedFr": notIncluded.fr,
  "notIncludedEn": notIncluded.en,
  ...
  "highlightsFr": highlights.fr,
  "highlightsEn": highlights.en,
  publishedAt,
  featured
}`;

export const prestationsSlugsQuery = (locale = "fr") => `*[_type == "prestation" && defined(slug.${locale}.current)] {
  "slug": slug.${locale}.current
}`;

export const featuredPrestationsQuery = (locale = "fr") => `*[_type == "prestation" && active == true && featured == true] | order(publishedAt desc) {
  _id,
  "title": title.${locale},
  "titleFr": title.fr,
  "titleEn": title.en,
